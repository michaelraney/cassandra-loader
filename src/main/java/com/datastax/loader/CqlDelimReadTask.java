...
class CqlDelimReadTask implements Callable<Long> {
    ...
    public CqlDelimReadTask(String inCqlSchema, String inDelimiter,
    ...
    private int sendInsert(List<Object> elements, String line) {
        BoundStatement bind = statement.bind(elements.get(0));
    ...
    private long execute() throws IOException {
        ...
        if (format.equalsIgnoreCase("delim")
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (null != elements) {
                    int ret = sendInsert(elements.subList(0,1), line);
                    if (-2 == ret) {
                        cleanup(false);
                        return -2;
                    }
